...
class NotificationTests: XCTestCase {
    ...
    func testBadgeNotificationHasBadgeFlagSetToTrue() throws {
        let note = try Fixtures.Notification.badge.insertInto(contextManager.mainContext)
    ...
    func testLikeNotificationReturnsTheProperKindValue() throws {
        let note = try Fixtures.Notification.like.insertInto(contextManager.mainContext)
    ...
    func testFollowerNotificationReturnsTheProperKindValue() throws {
        let note = try Fixtures.Notification.newFollower.insertInto(contextManager.mainContext)
    ...
    func testCommentNotificationReturnsTheProperKindValue() throws {
        let note = try Fixtures.Notification.repliedComment.insertInto(contextManager.mainContext)
    ...
    func testCommentNotificationIsUnapproved() throws {
        let note = try Fixtures.Notification.unapprovedComment.insertInto(contextManager.mainContext)
    ...
    func testPingbackNotificationIsPingback() throws {
        let notification = try Fixtures.Notification.pingback.insertInto(contextManager.mainContext)
